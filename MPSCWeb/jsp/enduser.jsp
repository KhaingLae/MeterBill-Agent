...
<body>
	...
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="/MPSCWeb/jsp/enduser.jsp">End
					User</a></li>
	...
	<div id="page">
		<div id="content">
			...
			<html:form action="/ViewUsers" method="POST">
				<div class="post">
					<h2 class="title">
					...
					<div class="entry">
						<table height="350">
							<tr>
								<td width="250">Enter Year:</td>
								<td width="100"><div class="select_wrapper">
							...
							<tr>
								<td><p class="login button" width="100%">
										<input type="submit" value="View Remaining Users"
											name="remain" />
									</p></td>
								<td><p class="login button" width="100%">
										<input type="submit" value="View Paid Users" name="paid" />
									</p></td>
							</tr>
						</table>
						<logic:notEmpty name="remain">
