...
<body>
		...
		<div id="menu">
			...
			<li class="current_page_item"><a href="/MPSCWeb/jsp/billpayment.jsp">View Bill Payment</a></li>
			...
			<div id="content">
				...
				<div class="post">
					<h2 class="title">
						...
						<h4><i>View Bill Payment</i></h4>
					


					<div class="entry">
						<html:form action="/BillPayment" method="POST">
							<table height="300">
								<tr>
									<td width="150">Enter Year:</td>
									<td><div class="select_wrapper"><html:select property="year">
								...
								<tr>
									<td>Enter Month:</td>
									<td><div class="select_wrapper"><html:select property="month">
					...
					<td>
								<p class="login button">
									<input type="submit" value="View Bill Payment" />
								</p>							
					</td>	  
							</table>
						...
						<p align="center">
									<b><i>Meter Bill Information for <bean:write name="userLoginForm" property="month"
						...
						<logic:empty name="balanceresultlist"><b>No data for selected time !</b></logic:empty>
</html:form>
